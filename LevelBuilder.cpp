...
DynamicBody *LevelBuilder::LoadLevel(Levels t_level_name)
{
	...
	{
		float mass2 = 100;
		m_world->AddGameObject(new DynamicBody("", Graphics::renderer, 30, 10, Vector2f(0, 0), 46, 46, mass2, 0.4f));
		m_world->AddGameObject(new DynamicBody("", Graphics::renderer, 110, 100, Vector2f(0, 0), 46, 46, mass2, 0.4f));
		...
		m_world->AddGameObject(new StaticBody("", Graphics::renderer, 10, 550, 600, 48, mass2, 20, 0, 0.4f));
	...
	case ANGRY_BIRDS:
	{
		...
		m_world->AddGameObject(new DynamicBody("./gfx/woodBox.jpg", Graphics::renderer, 410, 390 - 70, Vector2f(0, 0), 26, 200, mass2, 0.4f));
		m_world->AddGameObject(new DynamicBody("./gfx/woodBox.jpg", Graphics::renderer, 590, 390 - 70, Vector2f(0, 0), 26, 200, mass2, 0.4f));
